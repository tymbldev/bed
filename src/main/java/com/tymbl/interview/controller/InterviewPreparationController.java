...
public class InterviewPreparationController {
  ...
  public ResponseEntity<List<DesignationSkillDTO>> getTopicsByDesignation(
    ...
    List<DesignationSkillDTO> topics = interviewPreparationService.getTopicsByDesignation(
        designation);
  ...
  public ResponseEntity<List<DesignationSkillDTO>> getTopicsByDesignationWithFilters(
    ...
    if (difficultyLevel != null && category != null) {
      ...
      topics = interviewPreparationService.getTopicsByDesignationAndDifficulty(designation,
          com.tymbl.interview.entity.DesignationSkill.DifficultyLevel.valueOf(
  ...
  public ResponseEntity<List<InterviewQuestionDTO>> getGeneralQuestionsByDesignation(
    ...
    List<InterviewQuestionDTO> questions = interviewPreparationService.getGeneralQuestionsByDesignation(
        designation);
  ...
  public ResponseEntity<List<InterviewQuestionDTO>> getGeneralQuestionsByDesignationAndTopic(
    ...
    log.info("Fetching general questions for designation: {} and topic: {}", designation,
        topicName);
    List<InterviewQuestionDTO> questions = interviewPreparationService.getGeneralQuestionsByDesignationAndTopic(
        designation, topicName);
    return ResponseEntity.ok(questions);
  }
  ...
  public ResponseEntity<Page<InterviewQuestionDTO>> getGeneralQuestionsByDesignationAndTopicPaginated(
    ...
    log.info("Fetching paginated general questions for designation: {} and topic: {}", designation,
        topicName);
    Page<InterviewQuestionDTO> questions = interviewPreparationService.getGeneralQuestionsByDesignationAndTopicPaginated(
        designation, topicName, page, size);
    return ResponseEntity.ok(questions);
  }
  ...
  public ResponseEntity<List<InterviewQuestionDTO>> getCompanyQuestionsByCompanyAndDesignation(
    ...
    log.info("Fetching company questions for company: {} and designation: {}", companyName,
        designation);
    List<InterviewQuestionDTO> questions = interviewPreparationService.getCompanyQuestionsByCompanyAndDesignation(
  ...
  public ResponseEntity<List<InterviewQuestionDTO>> getCompanyQuestionsByCompanyAndDesignationAndTopic(
    ...
    List<InterviewQuestionDTO> questions = interviewPreparationService.getCompanyQuestionsByCompanyAndDesignationAndTopic(
        companyName, designation, topicName);
    return ResponseEntity.ok(questions);
  }
  ...
  public ResponseEntity<Page<InterviewQuestionDTO>> getCompanyQuestionsByCompanyAndDesignationAndTopicPaginated(
    ...
    log.info("Fetching paginated company questions for company: {}, designation: {} and topic: {}",
        companyName, designation, topicName);
    Page<InterviewQuestionDTO> questions = interviewPreparationService.getCompanyQuestionsByCompanyAndDesignationAndTopicPaginated(
        companyName, designation, topicName, page, size);
    return ResponseEntity.ok(questions);
  }
  ...
  public ResponseEntity<List<String>> getTopicsWithCompanyQuestions(
    ...
    log.info("Fetching topics with company questions for company: {} and designation: {}",
        companyName, designation);
    List<String> topics = interviewPreparationService.getTopicsWithCompanyQuestions(companyName,
        designation);
    return ResponseEntity.ok(topics);
  }
