...
public class InterviewGenerationController {
  ...
  public ResponseEntity<Map<String, Object>> generateTopicsForDesignation(
    ...
    List<Map<String, Object>> topics = interviewPreparationService.generateTopicsForDesignation(
        designation);
  ...
  public ResponseEntity<Map<String, Object>> generateAndSaveTopicsForDesignation(
    ...
    List<Map<String, Object>> generatedTopics = interviewPreparationService.generateTopicsForDesignation(
        designation);
    ...
    List<DesignationSkillDTO> savedTopics = interviewPreparationService.saveGeneratedTopics(
        designation, generatedTopics);
  ...
  public ResponseEntity<Map<String, Object>> requestQuestionGeneration(
    ...
    response.put("message",
        "Question generation request submitted successfully. Use the queue ID to check status.");
  ...
  public ResponseEntity<Map<String, Object>> generateAndSaveQuestionsForAllTopicsOfSkill(
    ...
    try {
      ...
      log.info(
          "Questions generated and (optionally) saved for all topics of skill: {}. Total questions added: {}",
          skillName, totalQuestions);
