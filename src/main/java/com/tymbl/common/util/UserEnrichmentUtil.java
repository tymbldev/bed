...
public class UserEnrichmentUtil {
    ...
    public User enrichUserWithDesignationName(User user) {
        try {
            ...
            logger.warn("Could not fetch designation name for designationId: {}. Error: {}", user.getDesignationId(), e.getMessage());
        }
        return user;
    }
    ...
    public User enrichUserWithDepartmentName(User user) {
        try {
            ...
            logger.warn("Could not fetch department name for departmentId: {}. Error: {}", user.getDepartmentId(), e.getMessage());
        }
        return user;
    }
    ...
    public User enrichUserWithCountryName(User user) {
        try {
            ...
            logger.warn("Could not fetch country name for countryId: {}. Error: {}", user.getCountryId(), e.getMessage());
        }
        return user;
    }
    ...
    public User enrichUserWithCityName(User user) {
        try {
            ...
            logger.warn("Could not fetch city name for cityId: {}. Error: {}", user.getCityId(), e.getMessage());
        }
        return user;
    }
