...
public class CrawlingService {
    ...
    public Optional<CrawlResult> crawlCompanyPage(String linkedinUrl) {
        try {
            ...
            log.info("Generating company information for: {} using Gemini AI", companyName);
            
            // Use Gemini AI to generate company information based on company name
            Optional<Company> generatedCompany = geminiService.generateCompanyInfo(companyName, linkedinUrl);
            ...
            if (generatedCompany.isPresent()) {
                ...
                company.setCrawledData("Generated using Gemini AI - Company: " + companyName);
                return Optional.of(new CrawlResult(company, "Generated using Gemini AI"));
            }
        } catch (Exception e) {
    ...
    private String createRawDataSummary(Company company) {
        ...
        summary.append("Company Information Generated by Gemini AI\n");
        summary.append("==========================================\n\n");
