...
public interface SimilarContentRepository extends JpaRepository<SimilarContent, Long> {
  ...
  List<SimilarContent> findByTypeAndSearchTerm(@Param("type") ContentType type,
  ...
  List<SimilarContent> findByTypeAndMinConfidence(@Param("type") ContentType type,
      @Param("minConfidence") Double minConfidence);

  Optional<SimilarContent> findByParentNameAndSimilarNameAndType(String parentName,
      String similarName, ContentType type);

  boolean existsByParentNameAndSimilarNameAndType(String parentName, String similarName,
      ContentType type);
}
