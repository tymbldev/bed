...
public class NotificationService {
  ...
  public void createCompanyJobsNotification(Long userId, String companyName, int jobCount) {
    String message = String.format("%d+ new openings at %s. Start accepting referrals from candidates today!", jobCount, companyName);
  ...
  public void createApplicationStatusNotification(com.tymbl.jobs.entity.JobApplication application, 
    ...
    try {
      ...
      String message = String.format("Your application has been %s.", status);
  ...
  public void createApplicationStatusNotification(Long userId, Long applicationId, 
    ...
    String message = String.format("Your application for '%s' has been %s.", jobTitle, status);
  ...
  public void createPostedJobApplicationsNotification(Long userId, Long jobId, 
    ...
    if (applicationCount == 1) {
      message = String.format("You have got a new applicant for your job '%s'.", jobTitle);
    } else {
      message = String.format("%d applicants have applied to your job '%s'.", applicationCount, jobTitle);
    }
