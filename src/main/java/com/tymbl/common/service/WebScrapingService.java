...
public class WebScrapingService {
    ...
    public Optional<String> extractTextFromUrl(String url) {
        ...
        try {
            ...
            if (extractedText != null && !extractedText.trim().isEmpty()) {
                ...
                log.info("Successfully extracted text from URL: {} (length: {})", url, extractedText.length());
     ...
     */
    private void saveUrlContent(String url, String extractedText, String status, String errorMessage) {
        try {
