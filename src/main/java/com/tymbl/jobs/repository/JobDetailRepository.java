...
public interface JobDetailRepository extends JpaRepository<JobDetail, Long> {
  ...
  List<JobDetail> findByPortalNameAndJobTitleContaining(@Param("portalName") String portalName,
  ...
  List<JobDetail> findByExperienceRange(@Param("minExp") Integer minExp,
