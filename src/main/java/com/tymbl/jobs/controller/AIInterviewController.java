...
public class AIInterviewController {
    ...
    public ResponseEntity<Map<String, Object>> generateComprehensiveInterviewQuestions() {
        try {
            ...
            errorResponse.put("error", "Error generating comprehensive interview questions: " + e.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> generateComprehensiveInterviewQuestionsForSkill(
        ...
        try {
            ...
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("error", "Error generating comprehensive interview questions for skill: " + e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorResponse);
        }
    }
    ...
    @Operation(
        ...
        description = "Uses Gemini to generate summary and detailed, HTML-rich interview questions for a given skill and topic, " +
    ...
    public ResponseEntity<Map<String, Object>> generateAndSaveQuestionsForSkillAndTopic(
        ...
        try {
            log.info("Starting question generation for skill: {} and topic: {} with {} questions", skillName, topicName, numQuestions);
            ...
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("error", "Error generating questions for skill and topic: " + e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorResponse);
        }
    }
    ...
    @Operation(
        ...
        description = "Loops through all topics for a skill and generates (and saves) questions for each topic using Gemini. " +
    ...
    public ResponseEntity<Map<String, Object>> generateAndSaveQuestionsForAllTopicsOfSkill(
            ...
            @RequestParam(defaultValue = "10") int numQuestions) {
        try {
            log.info("Starting question generation for all topics of skill: {} with {} questions per topic", skillName, numQuestions);
            ...
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("error", "Error generating questions for all topics of skill: " + e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorResponse);
        }
    }
    ...
    @Operation(
        ...
        description = "Loops through all enabled skills and all their topics, generates (and saves) questions for each topic using Gemini. " +
    ...
    public ResponseEntity<Map<String, Object>> generateAndSaveQuestionsForAllSkillsAndTopics(
            ...
            @RequestParam(defaultValue = "10") int numQuestions) {
        try {
            log.info("Starting question generation for all skills and topics with {} questions per topic", numQuestions);
            ...
            Map<String, Object> errorResponse = new HashMap<>();
            errorResponse.put("error", "Error generating questions for all skills and topics: " + e.getMessage());
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorResponse);
        }
    }
