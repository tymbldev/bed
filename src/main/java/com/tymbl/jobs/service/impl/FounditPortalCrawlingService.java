...
public class FounditPortalCrawlingService implements PortalCrawlingService {
    ...
    public String makePortalApiCall(JobCrawlKeyword keywordConfig, JobCrawlRequest request) {
        ...
        if (response.getStatusCode() != HttpStatus.OK) {
            throw new RuntimeException("Foundit API call failed with status: " + response.getStatusCode());
        }
    ...
    @Override
    public JobRawResponse saveRawResponse(JobCrawlKeyword keywordConfig, JobCrawlRequest request, String apiResponse) {
    ...
    @Override
    public List<JobDetail> parseAndSaveJobDetails(JobRawResponse rawResponse, String apiResponse, JobCrawlRequest request) {
    ...
    private JobDetail parseFounditJobNode(JsonNode jobNode, JobRawResponse rawResponse, JobCrawlRequest request) {
        ...
        if (companyNode != null) {
            ...
            jobDetail.setCompanyId(companyNode.has("companyId") ? companyNode.get("companyId").asText() : null);
        }
        ...
        if (locationsNode != null && locationsNode.isArray()) {
            ...
            for (JsonNode location : locationsNode) {
                ...
                if (city != null) locationStr.append(city);
                if (state != null) {
        ...
        jobDetail.setJobDescription(jobNode.has("description") ? jobNode.get("description").asText() : null);
        ...
        jobDetail.setRecruiterId(jobNode.has("recruiterId") ? jobNode.get("recruiterId").asText() : null);
