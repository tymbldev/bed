...
public class ExternalJobTagger {
  ...
  public TaggingResult tagExternalJob(ExternalJobDetail externalJob) {
    ...
    try {
      // Tag company
      CompanyTaggerService.CompanyTaggingResult companyResult = companyTaggerService.tagCompany(
          externalJob.getCompanyName(), externalJob.getId(), externalJob.getPortalName());
      ...
      // Tag designation
      DesignationTaggerService.DesignationTaggingResult designationResult = designationTaggerService.tagDesignation(
          externalJob.getJobTitle(), externalJob.getId(), externalJob.getPortalName());
      ...
      // Tag city
      CityTaggerService.CityTaggingResult cityResult = cityTaggerService.tagCity(
          externalJob.getCityName(), externalJob.getId(), externalJob.getPortalName());
      ...
      // Tag country
      CountryTaggerService.CountryTaggingResult countryResult = countryTaggerService.tagCountry(
          externalJob.getCountryName(), externalJob.getId(), externalJob.getPortalName());
      ...
      // Tag skills
      SkillTaggerService.SkillTaggingResult skillResult = skillTaggerService.tagSkills(
          externalJob.getSkillsJson(), externalJob.getId(), externalJob.getPortalName());
      ...
      // Tag job tags
      JobTagTaggerService.JobTagTaggingResult jobTagResult = jobTagTaggerService.tagJobTags(
          externalJob.getJobTagsJson(), externalJob.getId(), externalJob.getPortalName());
      result.setJobTags(jobTagResult.getJobTags());
      result.setJobTagConfidence(jobTagResult.getConfidence());

      log.info(
          "Tagged external job {}: Company={} (ID: {}, Confidence: {}), Designation={} (ID: {}, Confidence: {}), City={} (ID: {}, Confidence: {}), Country={} (ID: {}, Confidence: {}), Skills={} (IDs: {}, Confidence: {}), JobTags={} (Confidence: {})",
          externalJob.getId(),
  ...
  public static class TaggingResult {
    ...
    public Double getCompanyConfidence() {
      return companyConfidence;
    }

    public void setCompanyConfidence(Double companyConfidence) {
      this.companyConfidence = companyConfidence;
    }
    ...
    public Double getDesignationConfidence() {
      return designationConfidence;
    }

    public void setDesignationConfidence(Double designationConfidence) {
      this.designationConfidence = designationConfidence;
    }
    ...
    public Double getCityConfidence() {
      return cityConfidence;
    }

    public void setCityConfidence(Double cityConfidence) {
    ...
    public Double getSkillConfidence() {
      return skillConfidence;
    }

    public void setSkillConfidence(Double skillConfidence) {
    ...
    public Double getJobTagConfidence() {
      return jobTagConfidence;
    }

    public void setJobTagConfidence(Double jobTagConfidence) {
      this.jobTagConfidence = jobTagConfidence;
    }
  }
}
