-- Fix duplicate external job crawl keywords manually
...
FROM external_job_crawl_keywords 
...
DELETE FROM external_job_crawl_keywords 
...
ALTER TABLE external_job_crawl_keywords 
...
-- DELETE FROM external_job_crawl_keywords WHERE id IN (123, 124, 125);
-- DELETE FROM external_job_crawl_keywords WHERE id IN (456, 457);
